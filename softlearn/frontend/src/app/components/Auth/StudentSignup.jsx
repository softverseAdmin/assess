                ...
                <div className="mb-4 flex flex-1 flex-col">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-4 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-black dark:focus:border-primary"
                    />
                  </div>
                </div>
                <div className="mb-4 flex flex-1 flex-col">
