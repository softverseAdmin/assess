...
import { signIn } from "../../api/handleApis";
...
const ForgetPassword = () => {
  ...
  return (
    <div className="rounded-sm container mx-auto flex justify-center items-center min-h-screen p-8">
      <div className="flex flex-1 shadow-xl border rounded-lg">
        <div className="hidden w-full lg:flex flex-1 justify-center items-center bg-sky-300 rounded-l-lg py-4">
          <div className="text-center">
            <Link
              className="text-3xl font-semibold mb-5.5 inline-block"
              href="/"
            >
              SoftLearn
            </Link>

            <p className="2xl:px-20 py-4">
        ...
        <div className="w-full flex-1 py-3 border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 rounded-r-lg">
          <div className="p-4 ">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                <button
                  type="submit"
                  value="Sign In"
                  className="w-full cursor-pointer rounded-lg border border-primary bg-sky-600 p-4 text-white transition-all duration-500 ease-in-out hover:border-sky-700 hover:bg-opacity-90"
                >
                  Send OTP
                </button>
              </div>
